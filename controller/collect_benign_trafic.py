...
class CollectTrainingStatsApp(switch.SimpleSwitch13):
    """
    SDN controller application that collects normal/benign traffic statistics 
    for training the machine learning model.
    This controller collects flow statistics and labels them as benign (0).
    """
    def __init__(self, *args, **kwargs):
        """
        Initialize the collector application and create the CSV file for statistics.
        """
        ...
        # Create and initialize CSV file with headers for flow statistics
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        for stat in sorted([flow for flow in body if (flow.priority == 1) ], key=lambda flow:
            ...
            # Write flow stats to CSV file with label 0 (benign)
            file0.write("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}\n"
