...
class SimpleMonitor13(switch.SimpleSwitch13):
    """
    SDN controller application that uses Decision Tree to detect DDoS attacks.
    ...
    def flow_training(self):
        """
        Train the Decision Tree machine learning model using collected flow statistics.
        ...
        # Create and train Decision Tree classifier using entropy criterion
