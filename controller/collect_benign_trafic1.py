...
class CollectTrainingStatsApp(switch.SimpleSwitch13):
    ...
    This version doesn't create an initial CSV file, only appends to an existing one.
    """
    ...
    def _flow_stats_reply_handler(self, ev):
        """
        Process flow statistics replies from switches and append data to CSV file.
